...
export const config = {
  ...
  cucumberOpts: {
    require: ["./tests/**/step_definitions/**/*.step.ts"], // <string[]> (file/dir) require files before executing features  backtrace: false, // <boolean> show full backtrace for errors
