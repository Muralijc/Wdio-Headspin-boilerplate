import hsconfig  from './HSconfig.json';
...
export const config = {
    ...
    //
    // https://dev-gb-lhr-0.headspin.io:4010/v0/2586fcedf5ad406fb230382bb2f3a9a8/wd/hub
    // https://dev-gb-lhr-2.headspin.io:7016/v0/2586fcedf5ad406fb230382bb2f3a9a8/wd/hub

    // hostname: 'dev-gb-lhr-2.headspin.io',

    hostname: hsconfig.hostname,
    port: hsconfig.port,
    path: hsconfig.path,
    // Protocol: http | https
    protocol: hsconfig.protocol,
    //
    // =================
    // Service Providers
    // =================
    ...
    //
    specs: [
        '/Users/mjayara/Documents/HS-POC/tests/features/calcTest.feature',
    ],
    // Patterns to exclude.
    exclude: [
    ...
    capabilities: [
{
  "appium:platformName": hsconfig.platformName,
  "appium:udid": hsconfig.deviceNameId,
  "appium:deviceName": hsconfig.deviceName,
  "appium:automationName": hsconfig.automationName,
  "appium:bundleId": "com.apple.calculator",
    ...
    cucumberOpts: {
        require: ['./tests/features/step_definitions/calc.step.ts'],        // <string[]> (file/dir) require files before executing features
